...
public class XquestImportUtils {
	 ...
	 * @return
	 */
	public static String getPeptideWithDynamicModificationsRemoved( String pseq ) {
		return pseq.replaceAll( "\\[[^\\[]+\\]",  "" );
	}

	
	/**
	 * Whether or not the supplied sequence contains any dynamic mod information in the
	 * form of PEPTID[12.33]E
	 * @param pseq
	 * @return true if dynamic mod information is present, false if not
	 */
	public static boolean containsDynamicMods( String pseq ) {
		if( pseq.contains( "[" ) )
			return true;
	...
	public static Map<Integer,Collection<BigDecimal>>  getDynamicModsForOneSequence( String pseq ) throws ProxlGenXMLDataException {
